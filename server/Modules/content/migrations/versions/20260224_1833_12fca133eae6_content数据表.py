...
Revision ID: 12fca133eae6
Revises: 
Create Date: 2026-02-24 18:33:47.128866
...
def upgrade() -> None:
    ...
    sa.Column('topic_id', mysql.INTEGER(unsigned=True), nullable=True, comment='话题ID'),
    ...
    sa.ForeignKeyConstraint(['topic_id'], ['fa_content_topics.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    mysql_charset='utf8mb4',
    mysql_collate='utf8mb4_unicode_ci',
    ...
    sa.Column('category_id', mysql.INTEGER(unsigned=True), nullable=True, comment='分类ID，关联 content_categorys.id'),
    ...
    sa.Column('zhihu_content', sa.Text(), nullable=True, comment='知乎问题内容（JSON格式）'),
    sa.Column('zhihu_content_updated_at', sa.DateTime(), nullable=True, comment='知乎内容更新时间'),
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='创建时间'),
    sa.Column('updated_at', sa.DateTime(), nullable=True, comment='更新时间'),
    sa.ForeignKeyConstraint(['category_id'], ['fa_content_categorys.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index(op.f('ix_fa_content_topics_category_id'), 'fa_content_topics', ['category_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_fa_content_topics_category_id'), table_name='fa_content_topics')
