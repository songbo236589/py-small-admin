...
from Modules.quant.validators.quant_concept_validator import (
    QuantConceptAddUpdateRequest,
)


class QuantConceptController:
    """概念控制器 - 负责概念相关的API接口"""

    def __init__(self):
        """初始化概念控制器"""
        self.service = QuantConceptService()
    ...
    @validate_request_data(QuantConceptAddUpdateRequest)
    async def add(
        self,
        name: str = Form(..., description="概念名称"),
        code: str | None = Form(None, description="概念代码"),
        description: str | None = Form(None, description="概念描述"),
    ...
    async def edit(self, id: int = Path(..., description="概念ID")) -> JSONResponse:
        """获取概念信息（用于编辑）"""
    ...
    async def update(
        self,
        id: int = Path(..., description="概念ID"),
        name: str | None = Form(None, description="概念名称"),
        code: str | None = Form(None, description="概念代码"),
        description: str | None = Form(None, description="概念描述"),
