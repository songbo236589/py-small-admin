...
from Modules.quant.services.quant_industry_log_service import QuantIndustryLogService


class QuantIndustryLogController:
    """行业日志控制器 - 负责行业日志相关的API接口"""

    def __init__(self):
        """初始化行业日志控制器"""
        self.service = QuantIndustryLogService()
