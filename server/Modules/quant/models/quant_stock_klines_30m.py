...
class QuantStockKline30m(BaseTableModel, table=True):
    """
    30分钟K线数据表模型

    对应数据库表 quant_stock_klines_30m，存储股票30分钟K线数据。
    """

    # 表注释
    __table_comment__ = "30分钟K线数据表，存储股票30分钟K线数据"
