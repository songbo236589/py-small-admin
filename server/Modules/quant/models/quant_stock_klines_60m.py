...
class QuantStockKline60m(BaseTableModel, table=True):
    """
    60分钟K线数据表模型

    对应数据库表 quant_stock_klines_60m，存储股票60分钟K线数据。
    """

    # 表注释
    __table_comment__ = "60分钟K线数据表，存储股票60分钟K线数据"
