...
class QuantStockKline15m(BaseTableModel, table=True):
    """
    15分钟K线数据表模型

    对应数据库表 quant_stock_klines_15m，存储股票15分钟K线数据。
    """

    # 表注释
    __table_comment__ = "15分钟K线数据表，存储股票15分钟K线数据"
