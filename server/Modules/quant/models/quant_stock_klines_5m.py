...
class QuantStockKline5m(BaseTableModel, table=True):
    """
    5分钟K线数据表模型

    对应数据库表 quant_stock_klines_5m，存储股票5分钟K线数据。
    """

    # 表注释
    __table_comment__ = "5分钟K线数据表，存储股票5分钟K线数据"
