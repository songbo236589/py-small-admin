import { add, edit, update } from '@/services/quant/data/concept/api';
...
const FormIndex: React.FC<PorpsType> = (porps) => {
  ...
  const formData: API.QuantConceptForm = {
    id: null,
    name: '',
    code: '',
    sort: 1,
  ...
  return (
    <DrawerForm<API.QuantConceptForm>
      layout="horizontal"
      labelCol={{ span: 3 }}
      wrapperCol={{ span: 21 }}
      formRef={restFormRef}
          ...
          <div>
            <ProFormText
              ...
              fieldProps={{
                maxLength: 50,
                allowClear: true,
                placeholder: '请输入概念名称（如：人工智能、芯片、5G）',
                showCount: true,
              }}
            />
            ...
            <ProFormText
              ...
              fieldProps={{
                maxLength: 20,
                allowClear: true,
                placeholder: '请输入概念代码（如：AI、CHIP、5G）',
                showCount: true,
              }}
            />
