...
import { destroy, destroyAll, getList, setStatus } from '@/services/content/manage/topic/api';
...
import BatchFetchZhihuContent from './components/BatchFetchZhihuContent';
import BatchGenerateArticle from './components/BatchGenerateArticle';
import BatchGenerateDescription from './components/BatchGenerateDescription';
import BatchUpdateCategory from './components/BatchUpdateCategory';
  ...
  const columns: ProColumns<API.ContentTopic>[] = [
    ...
    },
    {
      ...
      fieldProps: {
        ...
        treeData: [{ title: '未分类', value: '__NONE__', children: [] }, ...categoryTreeData],
        showSearch: true,
