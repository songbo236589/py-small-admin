import { getList as getAccountList } from '@/services/content/manage/platform_account/api';
import { publishArticle, publishBatch } from '@/services/content/manage/publish/api';
