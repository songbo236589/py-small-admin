...
import { destroy, destroyAll, getLogs, retry } from '@/services/content/manage/publish/api';
  ...
  const columns: ProColumns<API.ContentPublishLogList>[] = [
    ...
    },
    {
      ...
      valueEnum: {
        ...
        xiaohongshu: { text: '小红书', status: 'xiaohongshu' },
      },
      render: (_, record) => {
    ...
    },
    {
      ...
      search: {
        transform: (value) => {
          return {
            'completed_at[start]': value[0],
            'completed_at[end]': value[1],
          };
        },
      },
    },
